<template>
     ...
     <!-- 轮播图区域 -->
       ...
       <swiper-item v-for="(item,index) in swiperList" :key="index">
         <navigator class="img-item" :url="'/subpkg/goods_detail/goods_detail?goods_id=' + item.goods_id">
       ...
       <view class="floor-item" v-for="(item, index) in floorList" :key="index">
         ...
         <view class="floor-img-box">
           ...
           <view class="right-img-box">
             <navigator :url="item2.url" class="right-img-item" v-if="index2" v-for="(item2, index2) in item.product_list" :key="index2">
